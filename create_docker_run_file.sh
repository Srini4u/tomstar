...
sed 's/\<TAG\>/$DOCKER_TAG/g' $DOCKERRUN_FILE
sed 's/\<DEPLOYMENT_BUCKET\>/$DEPLOYMENT_BUCKET/g' $DOCKERRUN_FILE
sed 's/\<IMAGE_NAME\>/$IMAGE_NAME/g' $DOCKERRUN_FILE
sed 's/\<EXPOSED_PORTS\>/$EXPOSED_PORTS/g' $DOCKERRUN_FILE
sed 's/\<AUTHENTICATION_KEY\>/$AUTHENTICATION_KEY/g' $DOCKERRUN_FILE
